nome_file = input("Inserire il nome del file: ", "s");
f_clock = input("Inserire la frequenza di clock in Hz: ");

%% Importazione dati
tabella = readtable(nome_file, NumHeaderLines = 0);
...
fmt = ['Sequenza di bit: ' repmat('%d', 1, length(sequenza_Q))];
